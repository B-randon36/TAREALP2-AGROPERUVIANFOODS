...
public class CategoriaController {
    ...
    @Operation(summary = "Navegación controlada: Lista los productos pertenecientes a una categoría por su ID")
    @GetMapping("/{id}/productos")
    public ResponseEntity<List<ProductoResponse>> listarProductosPorCategoria(@PathVariable Long id) {
