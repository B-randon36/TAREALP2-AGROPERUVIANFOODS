...
class CategoriaControllerTest {
    ...
    @Test
    void listarProductosPorCategoria_respondeOkConNavegacionControlada() throws Exception {
        when(productoService.listarPorCategoria(1L)).thenReturn(List.of(
                ProductoResponse.builder().id(10L).nombre("Teclado").precio(new BigDecimal("50.00")).stock(10).build()
        ));
    ...
    @Test
    void listarProductosPorCategoria_inexistente_respondeNotFound() throws Exception {
